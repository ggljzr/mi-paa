...
/*
 * Ukol 4 - Pokrocila iterativni heuristika (simulovane ochlazovani)
 * soubor: knapsack_3.c
 */

RESULT knapsack_annealing(DATA * data, double temp, double cooling, double frozen, char value_progress);
